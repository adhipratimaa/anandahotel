...
<div class="content">
 ...
 @if (count($errors) > 0)
    ...
    @endif
<form action="{{route('updateSlider',$detail->id)}}" method="post" enctype="multipart/form-data" id="form">
{{csrf_field()}}
<div class="row">
  <div class="col-md-8">
      ...
      <div class="box-body">
         <div class="form-group">
                 ...
                 <div class="form-group" id="wrapper">
                      <div id="image-holder">
                      <img src="{{asset('images/thumbnail')}}/{{$detail->image}}" class="thumb-image img-responsive" > 
                      <input type="hidden" name="image"  id="name" value="{{$detail->image}}">
                      </div>
                 </div>
                 <div class="form-group">
                     <button value="crop" type="button" id="crop" class="btn btn-success">crop</button>
                </div>
               <div class="form-group">
                 <label>For Page</label>
                 <select name="type" class="form-control">
                   <option value="home" {{$detail->type=='home'?'selected':''}}>Home page</option>
                   <option value="about" {{$detail->type=='about'?'selected':''}}>About Page</option>
                 </select>
               </div>
